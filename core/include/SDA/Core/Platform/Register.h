...
namespace sda
{
    ...
    public:
        ...
        std::string toString(const RegisterRepository* regRepo = nullptr, bool printSizeAndOffset = true) const;

        static Register Create(const RegisterRepository* regRepo, size_t registerId, size_t size);
    };
};