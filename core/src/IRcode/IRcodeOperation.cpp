...
const pcode::Instruction* Operation::getPcodeInstruction() const {
    return m_pcodeInstruction;
}

void Operation::setPcodeInstruction(const pcode::Instruction* instruction) {
    m_pcodeInstruction = instruction;
}
