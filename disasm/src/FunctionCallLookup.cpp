...
FunctionCallLookupCallbacks::FunctionCallLookupCallbacks(
    ...
    : m_constFunctionOffsets(constFunctionOffsets),
    PcodeBlockBuilder::StdCallbacks(builder, std::move(nextCallbacks))
{}
