...
bool Optimization::ExprSimpleConditionOptimization::processSBORROW(Condition* cond) {
...
bool Optimization::ExprSimpleConditionOptimization::moveTermToRightPartOfCondition(Condition* cond) {
