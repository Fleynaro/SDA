...
namespace sda::decompiler
{
    ...
    private:
        ...
        MemoryInfo getRegisterMemoryInfo(const pcode::RegisterVarnode* regVarnode) const;
        ...
        std::shared_ptr<ircode::Register> createRegister(const pcode::RegisterVarnode* regVarnode) const;
